...
if (isset($_GET["id"])) {
  $id = $_GET["id"];
  $results = sqlquery("SELECT * FROM $nama_tabel WHERE NO_INDUK = '$id'");
  ...
  echo "<script>
			document.location.href = '../../pages/murid.php';
		</script>";
}
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../../pages/murid.php" class="nav-link active">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input value="<?= $results[0][$sqlKey[6]]; ?>" type="date" class="form-control" id="<?= $sqlKey[6]; ?>" name="<?= $sqlKey[6]; ?>">
                    </div>
                  </div>
                  <!-- /.card-body -->
                </div>
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input value="<?= $results[0][$sqlKey[15]]; ?>" type="email" class="form-control" id="<?= $sqlKey[15]; ?>" name="<?= $sqlKey[15]; ?>">
                    </div>
                  </div>
                  <!-- /.card-body -->
                </div>
