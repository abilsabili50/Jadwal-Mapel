<?php
  ...
  $totalMapel = sqlquery("SELECT COUNT(*) as 'total_mapel' FROM mata_pelajaran");
  $totalRuang = sqlquery("SELECT COUNT(*) as 'total_ruang' FROM ruang_kelas");
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"><i class="nav-icon fas fa-graduation-cap"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Murid</span>
                <span class="info-box-number">
                  <?= $totalMurid[0]["total_murid"]; ?>
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-danger elevation-1"><i class="nav-icon fas fa-chalkboard-user"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Guru Pengajar</span>
                <span class="info-box-number"><?= $totalGuru[0]["total_guru"]; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?= $totalMapel[0]["total_mapel"]; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1"><i class="nav-icon fas fa-landmark"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Ruangan</span>
                <span class="info-box-number"><?= $totalRuang[0]["total_ruang"]; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
