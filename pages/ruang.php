...
if (isset($_GET["submitSearch"])) {
  $stringQuery = cari($_GET["keyword"], $nama_tabel, "NAMA_RUANG");
      ...
      <section class="content">
        <form action="" method="get">
          <div class="form-group">
            <div class="row">
              <div class="col-md-11">
                <input type="search" class="form-control" id="cariRuang" name="keyword" placeholder="Search by Name" autofocus>
              </div>
              <div class="col-md-1">
